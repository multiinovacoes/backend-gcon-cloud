...
import static br.com.multiinovacoes.gcon.controller.RespostaParcialLaiController.RESPOSTA_PARCIAL_LAI;
...
import br.com.multiinovacoes.gcon.model.mapper.RespostaParcialLaiMapper;
import br.com.multiinovacoes.gcon.model.request.RespostaParcialLaiRequest;
import br.com.multiinovacoes.gcon.model.response.ListaRespostaParcialLaiResponse;
import br.com.multiinovacoes.gcon.model.response.RespostaParcialLaiResponse;
import br.com.multiinovacoes.gcon.repository.RespostaParcialLaiRepository;
import br.com.multiinovacoes.gcon.service.RespostaParcialLaiService;
...
public class RespostaParcialLaiController {
	...
	public ListaRespostaParcialLaiResponse getRespostasParciais(@PathVariable Long codigo) {
		return new ListaRespostaParcialLaiResponse(respostaParcialService.getRespostaParcials(codigo));
	}
	...
	public RespostaParcialLaiResponse getEditarRespostaParcial(@PathVariable Long codigo) {
		return new RespostaParcialLaiResponse(respostaParcialService.getRespostaParcial(codigo));
	}
